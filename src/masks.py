...
def get_mask_card_number(card_num: str) -> str:
    ...
    if len(card_num) != 16:
        app_logger.error("Неправильно введен номер банковской карты. Остановка работы.")
...
def get_mask_account(card_id: str) -> str:
    ...
    if len(card_id) != 20:
        app_logger.error("Неправильно введен номер банковского счета. Остановка работы.")
