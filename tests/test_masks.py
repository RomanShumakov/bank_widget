...
def test_get_mask_card_number(card_num):
    """Функция проверяет работоспособность get_mask_card_number при различных вариантах ввода номера банковской карты"""
...
def test_get_mask_account(card_id):
    """Функция проверяет работоспособность get_mask_account при различных вариантах ввода номера банковского счета"""
